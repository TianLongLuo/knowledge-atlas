...
_IDENTITY_FACETS = [
    ("identity", "Who am I? What is my background, profession, role, and self-description?"),
    ("projects", "What am I currently working on? What projects, tasks, or actions am I engaged in?"),
    ("goals", "What are my goals, ambitions, and aspirations? What am I working toward?"),
    ("values", "What do I value, believe, and care about? What principles guide me?"),
    ("concerns", "What recurring concerns, tensions, or challenges appear in my notes?"),
    ("decisions", "What decisions have I made or am I considering? What changes am I navigating?"),
    ("recent", "What has changed recently? What new developments or shifts appear in my most recent notes?"),
]
